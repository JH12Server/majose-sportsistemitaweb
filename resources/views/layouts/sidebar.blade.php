<div id="sidebar" class="active">
    <div class="sidebar-wrapper active ps ps--active-y">
        ...
        <ul class="menu" id="sidebar-menu">
            ...
            <li><a href="#" class="d-flex align-items-center gap-2"><i class="bi bi-megaphone"></i><span class="link_name">Billboard</span><span class="badge bg-danger ms-2">New</span></a></li>
