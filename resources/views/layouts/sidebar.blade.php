<div id="sidebar" class="active">
    <div class="sidebar-wrapper active ps ps--active-y">
        ...
        <ul class="menu" id="sidebar-menu">
            ...
            <li><a href="{{ route('pagos.verificacion') }}" class="d-flex align-items-center gap-2 {{ request()->routeIs('pagos.verificacion') ? 'active' : '' }}"><i class="bi bi-credit-card"></i><span class="link_name">Verificación Pagos</span><span class="badge bg-danger ms-2">New</span></a></li>
        ...
        <ul class="menu">
            ...
            <li><a href="{{ route('worker.dashboard') }}" class="d-flex align-items-center gap-2 {{ request()->routeIs('worker.dashboard') ? 'active' : '' }}"><i class="bi bi-shield"></i><span class="link_name">Autorización de Pedidos y Compras</span></a></li>
        </ul>
        <div class="sidebar-section-title px-4 mt-3 mb-1 text-uppercase text-muted small">MANUAL USER</div>
        <ul class="menu">
            <li><a href="{{ url('/manual.html') }}" target="_blank" class="d-flex align-items-center gap-2"><i class="bi bi-journal-bookmark"></i><span class="link_name">Manual</span><span class="badge bg-danger ms-2">New</span></a></li>
        </ul>
