        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-4">
                    <h1 class="text-2xl font-bold text-gray-900">Mi Perfil de Cliente (Nuevo)</h1>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mt-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-lg font-semibold text-blue-600">{{ $customerStats['total_orders'] ?? 0 }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600">Pedidos entregados</span>
                            <span class="text-lg font-semibold text-green-600">{{ $customerStats['orders_delivered'] ?? 0 }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600">En progreso</span>
                            <span class="text-lg font-semibold text-orange-600">{{ $customerStats['orders_in_progress'] ?? 0 }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600">Pedidos mes pasado</span>
                            <span class="text-lg font-semibold text-indigo-600">{{ $customerStats['last_month_orders'] ?? 0 }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600">Total gastado</span>
                            <span class="text-lg font-semibold text-purple-600">${{ number_format($customerStats['spent_total'] ?? 0, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Mis Pedidos Recientes</h3>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">Aún no tienes pedidos</h3>
                            <p class="mt-1 text-sm text-gray-500">Explora el catálogo y realiza tu primera compra.</p>
                        </div>
                    @endif
                </div>
            </div>
